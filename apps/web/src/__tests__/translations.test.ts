...
const whitelist = [
  ...
  'Sort Title Z-A',
  'All articles',
  'Learn basics of OpenWorldSwap',
  'Learn how',
  'You might also like',
  'Chef’s choice',
  'Recommended Readings by Chefs',
  'Latest News about OpenWorldSwap and more!',
  'Gaming Announcements',
  'OpenWorldSwap Gaming Community',
  'Gaming Community',
  ...
  'Start Building',
  'Build Games with OpenWorldSwap Now',
  'Bring Your Game to Life on OpenWorldSwap',
  ...
  'OpenWorldSwap operates on 9 popular blockchains, welcoming developers from diverse ecosystems',
  ...
  'OpenWorldSwap Gaming Marketplace',
  'Play, Build and Connect on OpenWorldSwap',
  'Flagship',
  'Published By',
  'Publish Date: %date%',
  'Publisher:',
