...
const UNIVERSAL_ROUTER_ADDRESSES: Record<ChainId, Address> = {
  ...
  [ChainId.OEX_TESTNET]: '0xF9956Ba9D9F199A2a9B7D6a62969800a074EcC54',
  [ChainId.MATCHAIN]: '0x812048464C976F4293708ADe043F1B52e5ae19BC',
  [ChainId.FIVEIRE]: '0x812048464C976F4293708ADe043F1B52e5ae19BC',
}
