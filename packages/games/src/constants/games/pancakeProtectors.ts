...
export const pancakeProtectors: GameType = {
  ...
  description:
    'OpenWorldSwap and Mobox joined forces to launch a tower-defense and PvP game tailored for GameFi players, as well as CAKE, Pancake Squad, and Bunnies holders.',
  ...
  playlist: [
    {
      videoId: '80j7QpNqKcI',
      title: 'Unleashing the Power of Pancake Protectors: A Web3 Gaming Adventure on OpenWorldSwap',
    },
    {
      videoId: '--UcFQ64sjY',
  ...
  socialMedia: {
    telegram: 'https://t.me/OpenWorldSwap/2991960',
