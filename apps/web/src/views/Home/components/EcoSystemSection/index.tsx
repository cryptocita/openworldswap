...
const useTradeBlockData = () => {
  ...
  const [onUSCitizenModalPresent] = useModal(
    <USCitizenConfirmModal title={t('OpenWorldSwap Perpetuals')} id={IdType.PERPETUALS} />,
    true,
    false,
  ...
  return useMemo(() => {
    return [
      ...
      },
      {
        ...
        description: t('Automate your OpenWorldSwap v3 liquidity'),
        ctaTitle: t('Stake Now'),
    ...
    return [
      {
        ...
        description: t('Play, Build and Connect on OpenWorldSwap'),
        ctaTitle: t('Play Now'),
