...
const UsAgreement = () => {
  return (
    <AffiliatesProgramLayout>
      <Container>
        <Text as="h1">OpenWorldSwap Affiliate Program Agreement</Text>
        <Text as="h3">Last modified: Sep 1, 2023</Text>
        <Text as="p">
          This OpenWorldSwap Affiliate Program Agreement (“<strong>Agreement”</strong>) is a legal contract between you
          (“
          <strong>Affiliate”</strong>) and OpenWorldSwap that applies to your participation in the OpenWorldSwap
          Affiliate Program (“Program”). In this Agreement, “<strong>OpenWorldSwap</strong>,” “<strong>we</strong>” or “
          <strong>us</strong>” means OpenWorldSwap. If you are participating or registering on behalf of a business,
          then the term “<strong>you</strong>” means such business, and you represent and warrant that you have
          authority to bind that business to this Agreement. By participating or registering to participate in the
          Program, or otherwise indicating your acceptance of this Agreement (such as by clicking a button or checking a
          box on a web page), you agree to this Agreement which may be amended from time to time by OpenWorldSwap.
        </Text>
        ...
        <Text as="p">
          ...
          users (“<strong>Referrals”</strong>) to register and trade on OpenWorldSwap, in accordance with the terms of
          this Agreement.
        </Text>
        <Text as="p">
          1.2 A Referral must be a new user and must not have interacted or signed with the OpenWorldSwap platform or
          used any of OpenWorldSwap’s services (including but not limited to V2, V3 swapping services, perpetual
          trading, Non-Fungible Tokens and related services, initial farm offerings and similar offerings)
          (“OpenWorldSwap Services”).
        </Text>
        ...
        <Text as="p">
          (a) <strong>3</strong>% on trading fees paid by your Referrals on OpenWorldSwap V2 and OpenWorldSwap V3,
        ...
        <Text as="p">
          7.3 Any statements you make about OpenWorldSwap must reflect your honest opinions, beliefs, or experiences and
        ...
        <Text as="p">You warrant, represent, and undertake to OpenWorldSwap that:</Text>
        ...
        <Text as="p">
          ...
          not that of employer and employee. You will not be treated as an employee of OpenWorldSwap for any purpose.
          ...
          offers or representations on behalf of OpenWorldSwap. You shall have no authority to bind OpenWorldSwap, and
          undertake not to hold yourself out as an employee, agent or authorised representative of OpenWorldSwap.
        </Text>

        <Text as="h3">12. No Joint Publicity</Text>
        <Text as="p">
          You may not claim that any materials are created jointly between you and OpenWorldSwap, or attribute any
          materials created or issued by you (including press releases) to OpenWorldSwap.
        </Text>

        <Text as="h3">13. Term and Termination</Text>
        <Text as="p">
          13.1 OpenWorldSwap reserves the right to terminate this Agreement in its entirety with or without cause,
          ...
          reason, you shall immediately cease use of (and remove from your site) all links to the OpenWorldSwap website
          and all images of OpenWorldSwap and other materials provided under the Program.
        </Text>
        <Text as="p">
          13.2 OpenWorldSwap, in its sole discretion, reserves the right to suspend or terminate your account and refuse
          any and all current or future use of the Program, or any other OpenWorldSwap service, for any reason and at
          any time. Such termination will result in the deactivation or deletion of your Affiliate Account.
        </Text>
        <Text as="p">
          13.3 OpenWorldSwap reserves the right to refuse service to anyone for any reason at any time.
        </Text>

        <Text as="h3">14. Indemnification</Text>
        <Text as="p">
          You shall indemnify OpenWorldSwap from and against all claims, losses, liabilities, damages, administrative
        ...
        <Text as="p">
          OpenWorldSwap and any of OpenWorldSwap&apos;s officers, directors, employees, shareholders or agents of any of
        ...
        <Text as="p">
          (e) directing or causing existing users or previous users of OpenWorldSwap Services to create new addresses to
          sign up with your referral link
        </Text>
        <Text as="p">
          (f) Conduct marketing or make any representations of any OpenWorldSwap products and services to users in the
        ...
        <Text as="p">
          OpenWorldSwap may provide you with trademarks and/or graphical images that can be used to promote
          OpenWorldSwap. You may not modify these trademarks and/or images in any way. OpenWorldSwap reserves the right
        ...
        <Text as="p">
          ...
          relationship as an Affiliate which is promoting OpenWorldSwap. For example:
        </Text>
        <Text as="p">
          (a) If you promote OpenWorldSwap through a web page, podcast, blog post, or social media post as an
          endorsement or review of OpenWorldSwap or incentivise others to do so, you must ensure that such post includes
          a clear disclosure that it is an advertisement or was otherwise promoted by OpenWorldSwap; and
        </Text>
        <Text as="p">
        ...
        <Text as="p">
          ...
          Zambia, Zimbabwe (or any additional country or jurisdiction added to this list by OpenWorldSwap from time to
