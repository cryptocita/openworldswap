...
const TermsOfService = () => {
  return (
    <Container>
      <Text as="h1">OpenWorldSwap Terms of Service</Text>
      ...
      <Text as="p">
        ...
        OpenWorldSwap protocol” or the “Protocol”), among other services. The Website is one, but not the exclusive,
      ...
      <Text as="p">
        ...
        Chain, Aptos and Ethereum. OpenWorldSwap does not control or operate any version of the Protocol on any
        ...
        matter, the OpenWorldSwap team is not a liquidity provider into Protocol liquidity pools and liquidity providers
      ...
      <Text as="p">
        OpenWorldSwap owns all intellectual property and other rights in the Website and its contents, including (but
      ...
      <Text as="p">
        ...
        such as rarity scores, token explorer or token lists (which includes the OpenWorldSwap default token list and
        OpenWorldSwap expanded list hosted at tokenlists.org). We may also provide warning labels for certain tokens.
      ...
      <Text as="p">
        ...
        of any other digital tokens which are transacted on OpenWorldSwap.
      </Text>
      <Text as="p">
      ...
      <Text as="p">
        ...
        as otherwise expressly set forth in the terms of another offer by OpenWorldSwap, you will be solely responsible
