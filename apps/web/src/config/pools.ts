...
export const POOLS_FAST_REVALIDATE = {
  ...
  [ChainId.OEX_TESTNET]: 10_000,
  [ChainId.MATCHAIN]: 10_000,
  [ChainId.FIVEIRE]: 10_000,
...
export const POOLS_NORMAL_REVALIDATE = {
  ...
  [ChainId.OEX_TESTNET]: 15_000,
  [ChainId.MATCHAIN]: 15_000,
  [ChainId.FIVEIRE]: 15_000,
} as const satisfies Record<ChainId, number>
...
export const POOLS_SLOW_REVALIDATE = {
  ...
  [ChainId.OEX_TESTNET]: 20_000,
  [ChainId.MATCHAIN]: 20_000,
  [ChainId.FIVEIRE]: 20_000,
} as const satisfies Record<ChainId, number>
