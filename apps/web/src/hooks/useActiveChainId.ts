...
export const useActiveChainId = () => {
  ...
  const chainId = localChainId ?? wagmiChainId ?? (queryChainId >= 0 ? ChainId.OEX_TESTNET : undefined)
  ...
  return {
    chainId: chainId && isChainSupported(chainId) ? chainId : ChainId.OEX_TESTNET,
    isWrongNetwork,
    isNotMatched,
  }
}
